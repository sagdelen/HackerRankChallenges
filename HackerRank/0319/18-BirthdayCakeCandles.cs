        ...
        */
        ...
        public static void Execute()
        {
            TextWriter textWriter =
                new StreamWriter(
                    Environment.GetEnvironmentVariable("OUTPUT_PATH") ?? throw new InvalidOperationException(),
                    true
                );
        ...
        {
            return ar.GroupBy(x => x).OrderByDescending(x => x.Key).FirstOrDefault()?.Count() ?? 0;
        }
    }
}